...
<head>
    ...
    <title>Enrollment Form - {{ $enrollment->student ? ($enrollment->student->application?->last_name . ', ' . $enrollment->student->application?->first_name) : 'Learner' }}</title>
    <style>
...
<body>
    <div class="no-print actions">
        ...
        <a href="{{ route('guidance.enrollments.show', $enrollment) }}" class="btn" style="background: #6b7280;">Back to details</a>
    </div>
