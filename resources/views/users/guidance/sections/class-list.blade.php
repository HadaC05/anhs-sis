...
<head>
    ...
    <title>School Form 1 (SF 1) - {{ $section->name }}</title>
    <style>
...
<body>
    ...
    <div class="no-print" style="margin-bottom: 12px;">
        ...
        <a href="{{ route('guidance.sections.class-list.pdf', $section) }}" class="btn btn-pdf">Download PDF</a>
        <a href="{{ route('guidance.sections.show', $section) }}" class="btn btn-back">Back to section</a>
    </div>
    @endif
