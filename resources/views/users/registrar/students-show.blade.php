            ...
            <div class="mb-6 rounded-xl border border-gray-200 bg-white p-5">
                <div class="flex flex-wrap items-center justify-between gap-3 mb-4">
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('registrar.students.sf9', ['student' => $student, 'enrollment' => $enrollment]) }}" target="_blank" class="inline-flex items-center justify-center rounded-lg bg-[#296374] px-3 py-2 text-xs font-bold uppercase tracking-wide text-white shadow-sm hover:opacity-90">
                            View / Print SF9
                        </a>
                        @if($loop->first)
                        <a href="{{ route('registrar.students.sf10', $student) }}" target="_blank" class="inline-flex items-center justify-center rounded-lg border border-[#296374]/30 bg-white px-3 py-2 text-xs font-bold uppercase tracking-wide text-[#296374] shadow-sm hover:bg-[#296374]/5">
                            View / Print SF10
                        </a>
                        @endif
